...
const MainSidebar = () => {
    ...
    <>
              ...
              <div className="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
                ...
                <div className="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6" onClick={()=> setProfile(false)}>
                  {/* Dashobards */}
                  <a className={`flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 dark:hover:bg-navy-450 dark:focus:bg-navy-450 cursor-poniter ${tabSelected === 1 ? "bg-primary/10 text-primary active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:active:bg-navy-450/90" : ""}`} onClick={()=> setTabSelected(1)}>
                  ...
                  {/* Apps */}
                  <a className={`flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 dark:hover:bg-navy-450 dark:focus:bg-navy-450 cursor-poniter ${tabSelected === 2 ? "bg-primary/10 text-primary active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:active:bg-navy-450/90" : ""}`} onClick={()=> setTabSelected(2)}>
                  ...
                  {/* Pages And Layouts */}
                  <a className={`flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 dark:hover:bg-navy-450 dark:focus:bg-navy-450 cursor-poniter ${tabSelected === 3 ? "bg-primary/10 text-primary active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:active:bg-navy-450/90" : ""}`} onClick={()=> setTabSelected(3)}>
                    <svg className="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Forms */}
                  <a className={`flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 dark:hover:bg-navy-450 dark:focus:bg-navy-450 cursor-poniter ${tabSelected === 4 ? "bg-primary/10 text-primary active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:active:bg-navy-450/90" : ""}`} onClick={()=> setTabSelected(4)}>
                    <svg className="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Components */}
                  <a className={`flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 dark:hover:bg-navy-450 dark:focus:bg-navy-450 cursor-poniter ${tabSelected === 5 ? "bg-primary/10 text-primary active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:active:bg-navy-450/90" : ""}`} onClick={()=> setTabSelected(5)}>
                    <svg className="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Elements */}
                  <a className={`flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 dark:hover:bg-navy-450 dark:focus:bg-navy-450 cursor-poniter ${tabSelected === 6 ? "bg-primary/10 text-primary active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:active:bg-navy-450/90" : ""}`} onClick={()=> setTabSelected(6)}>
                    <svg className="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col items-center space-y-3 py-3">
                  {/* Settings */}
                  <a href="form-layout-5.html" className="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" onClick={()=> setProfile(false)}>
                    <svg className="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div  className={`popper-root fixed ${profile === true ? "show" : ""}`} data-popper-placement="right-end" style={{position: 'fixed', inset: 'auto auto 0px 0px', margin: 0, transform: 'translate(76px, 32px)'}}><div className="popper-box w-64 rounded-lg border border-slate-150 bg-white shadow-soft dark:border-navy-600 dark:bg-navy-700">
          ...
          <button className="btn h-9 w-full space-x-2 bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
           ...
           <div className="sidebar-panel" onClick={()=> setProfile(false)}>
            ...
            <div className="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750" style={{display : tabSelected !== 1 && 'none' }}>
              ...
              {/* ApiLinks Sidebar */}
         <div className="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750" onClick={()=> setProfile(false)} style={{display : tabSelected !== 3 && 'none' }}>
  {/* Sidebar Panel Header */}
  <div className="flex h-18 w-full items-center justify-between pl-4 pr-1">
    <p className="text-base tracking-wider text-slate-800 dark:text-navy-100">
      Api
