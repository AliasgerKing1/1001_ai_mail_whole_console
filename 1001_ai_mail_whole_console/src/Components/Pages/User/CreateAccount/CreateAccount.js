...
<MainSidebar />
          ...
          <div className="sidebar-panel">
            <div className="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
              ...
              {/* Sidebar Panel Body */}
              <div x-data="{expandedItem:null}" className="h-[calc(100%-4.5rem)] overflow-x-hidden pb-6 simplebar-scrollable-y" x-init="$el._x_simplebar = new SimpleBar($el);" data-simplebar="init"><div className="simplebar-wrapper" style={{margin: '0px 0px -24px'}}><div className="simplebar-height-auto-observer-wrapper"><div className="simplebar-height-auto-observer" /></div><div className="simplebar-mask"><div className="simplebar-offset" style={{right: '0px', bottom: '0px'}}><div className="simplebar-content-wrapper" tabIndex={0} role="region" aria-label="scrollable content" style={{height: '100%', overflow: 'hidden scroll'}}><div className="simplebar-content" style={{padding: '0px 0px 24px'}}>
                          <ul className="flex flex-1 flex-col px-4 font-inter">
                            <li>
                              <a x-data="navLink" href="form-layout-1.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Form layout v1
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-layout-2.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out font-medium text-primary dark:text-accent-light">
                                Form layout v2
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-layout-3.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Form layout v3
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-layout-4.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Form layout v4
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-layout-5.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Form layout v5
                              </a>
                            </li>
                          </ul>
                          ...
                          <ul className="flex flex-1 flex-col px-4 font-inter">
                            <li>
                              <a x-data="navLink" href="form-input-text.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Input text
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-input-group.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Input group
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-input-mask.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Input mask
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-checkbox.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Checkbox
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-radio.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Radio
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-switch.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Switch
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-select.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Select
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-tom-select.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Tom select
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-textarea.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Textarea
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-range.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Range
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-datepicker.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Datepicker
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-timepicker.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Timepicker
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-datetimepicker.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Datetimepicker
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-richtexteditor.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Text editor
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-upload.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Form upload
                              </a>
                            </li>
                            <li>
                              <a x-data="navLink" href="form-validation.html" className="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                                Form validation
                              </a>
                            </li>
                          </ul>
                        </div></div></div></div><div className="simplebar-placeholder" style={{width: '240px', height: '763px'}} /></div><div className="simplebar-track simplebar-horizontal" style={{visibility: 'hidden'}}><div className="simplebar-scrollbar" style={{width: '0px', display: 'none'}} /></div><div className="simplebar-track simplebar-vertical" style={{visibility: 'visible'}}><div className="simplebar-scrollbar" style={{height: '146px', display: 'block', transform: 'translate3d(0px, 0px, 0px)'}} /></div></div>
            </div>
          </div>
        </div>
        {/* App Header Wrapper*/}
        ...
        {/* Right Sidebar */}
        <div x-show="$store.global.isRightSidebarExpanded" style={{display: 'none'}}>
          ...
          <div className="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
            <div className="relative flex h-full w-full transform-gpu flex-col bg-white transition-transform duration-200 dark:bg-navy-750" style={{display: 'none'}}>
              <div className="flex items-center justify-between py-2 px-4">
                ...
                <p x-show="activeTab === 'tabProjects'" className="flex shrink-0 items-center space-x-1.5" style={{display: 'none'}}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                  </svg>
                  <span className="text-xs">Projects</span>
                </p>
                <p x-show="activeTab === 'tabActivity'" className="flex shrink-0 items-center space-x-1.5" style={{display: 'none'}}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              ...
              <div className="is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
                ...
                <div className="mt-3">
                  ...
                  <div className="swiper mt-3 px-3 swiper-initialized swiper-horizontal" x-init="$nextTick(()=>new Swiper($el,{  slidesPerView: 'auto', spaceBetween: 16}))">
                    <div className="swiper-wrapper" style={{transitionDuration: '0ms', transitionDelay: '0ms'}} id="swiper-wrapper-1c9f2dcf57dc6606" aria-live="polite">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-3 px-3">
                    <div className="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                      <div className="flex items-center space-x-2">
                        <img className="h-10 w-10" src="images/logos/bitcoin.svg" alt="image" />
                        <div>
                      ...
                      <div className="ax-transparent-gridline">
                        <div style={{minHeight: '100px'}}><div id="apexchartsuctcmxtr" className="apexcharts-canvas apexchartsuctcmxtr" style={{width: '0px', height: '100px'}}><svg id="SvgjsSvg1018" width={0} height={100} xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" className="apexcharts-svg" transform="translate(0, 0)" style={{background: 'transparent'}}><foreignObject x={0} y={0} width={0} height={100}><div className="apexcharts-legend" xmlns="http://www.w3.org/1999/xhtml" /></foreignObject><g id="SvgjsG1020" className="apexcharts-inner apexcharts-graphical"><defs id="SvgjsDefs1019" /></g></svg></div></div>
                      </div>
                    ...
                    <div className="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                      <div className="flex items-center space-x-2">
                        <img className="h-10 w-10" src="images/logos/solana.svg" alt="image" />
                        <div>
                          <h2 className="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                            SOL
                          </h2>
                      ...
                      <div className="ax-transparent-gridline">
                        <div style={{minHeight: '100px'}}><div id="apexchartsita6hb1yf" className="apexcharts-canvas apexchartsita6hb1yf" style={{width: '0px', height: '100px'}}><svg id="SvgjsSvg1021" width={0} height={100} xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" className="apexcharts-svg"transform="translate(0, 0)" style={{background: 'transparent'}}><foreignObject x={0} y={0} width={0} height={100}><div className="apexcharts-legend" xmlns="http://www.w3.org/1999/xhtml" /></foreignObject><g id="SvgjsG1023" className="apexcharts-inner apexcharts-graphical"><defs id="SvgjsDefs1022" /></g></svg></div></div>
                      </div>
                      <div className="mt-2 flex items-center justify-between">
                        <p className="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                          20.56$
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-3 space-y-3 px-2">
                    <div className="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                      ...
                      <img src="images/object/object-18.jpg" className="h-20 w-20 rounded-lg object-cover object-center" alt="image" />
                    </div>
                    <div className="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                      <div className="flex flex-1 flex-col justify-between">
                        <div className="line-clamp-2">
                      ...
                      <img src="images/object/object-2.jpg" className="h-20 w-20 rounded-lg object-cover object-center" alt="image" />
                    </div>
                    <div className="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                      <div className="flex flex-1 flex-col justify-between">
                        <div className="line-clamp-2">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            <div className="avatar h-7 w-7">
                              <img className="rounded-full" src="images/avatar/avatar-18.jpg" alt="avatar" />
                            </div>
                            <div>
                              <p className="text-xs font-medium line-clamp-1">
                                Alfredo E .
                      ...
                      <img src="images/object/object-1.jpg" className="h-20 w-20 rounded-lg object-cover object-center" alt="image" />
                    </div>
                  </div>
                </div>
              ...
              <div className="is-scrollbar-hidden overflow-y-auto overscroll-contain px-3 pt-1" style={{display: 'none'}}>
                ...
                <div className="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                  <div className="flex items-center space-x-3">
                    <img className="h-10 w-10 rounded-lg object-cover object-center" src="images/illustrations/lms-ui.svg" alt="image" />
                    <div>
                  ...
                  <div className="mt-3 flex items-center justify-between space-x-2">
                    <div className="flex -space-x-3">
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-16.jpg" alt="avatar" />
                      </div>
                      <div className="avatar h-7 w-7 hover:z-10">
                      ...
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-20.jpg" alt="avatar" />
                      </div>
                    </div>
                ...
                <div className="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                  <div className="flex items-center space-x-3">
                    <img className="h-10 w-10 rounded-lg object-cover object-center" src="images/illustrations/store-ui.svg" alt="image" />
                    <div>
                      <p className="font-medium leading-snug text-slate-700 dark:text-navy-100">
                        Store Dashboard
                      </p>
                  ...
                  <div className="mt-3 flex items-center justify-between space-x-2">
                    <div className="flex -space-x-3">
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-17.jpg" alt="avatar" />
                      </div>
                      <div className="avatar h-7 w-7 hover:z-10">
                      ...
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-19.jpg" alt="avatar" />
                      </div>
                    </div>
                    <button className="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                  <div className="flex items-center space-x-3">
                    <img className="h-10 w-10 rounded-lg object-cover object-center" src="images/illustrations/chat-ui.svg" alt="image" />
                    <div>
                      <p className="font-medium leading-snug text-slate-700 dark:text-navy-100">
                        Chat Mobile App
                      </p>
                  ...
                  <div className="mt-3 flex items-center justify-between space-x-2">
                    <div className="flex -space-x-3">
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-5.jpg" alt="avatar" />
                      </div>
                      <div className="avatar h-7 w-7 hover:z-10">
                      ...
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-11.jpg" alt="avatar" />
                      </div>
                    </div>
                    <button className="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                  <div className="flex items-center space-x-3">
                    <img className="h-10 w-10 rounded-lg object-cover object-center" src="images/illustrations/nft.svg" alt="image" />
                    <div>
                      <p className="font-medium leading-snug text-slate-700 dark:text-navy-100">
                        NFT Marketplace App
                      </p>
                  ...
                  <div className="mt-3 flex items-center justify-between space-x-2">
                    <div className="flex -space-x-3">
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-8.jpg" alt="avatar" />
                      </div>
                      <div className="avatar h-7 w-7 hover:z-10">
                      ...
                      <div className="avatar h-7 w-7 hover:z-10">
                        <img className="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-12.jpg" alt="avatar" />
                      </div>
                    </div>
                    <button className="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1" style={{display: 'none'}}>
                  ...
                  <li className="timeline-item">
                    ...
                    <div className="timeline-item-content flex-1 pl-4">
                      ...
                      <div className="avatar mt-2 h-20 w-20">
                        <img className="mask is-squircle" src="images/avatar/avatar-19.jpg" alt="avatar" />
                      </div>
                    </div>
                  </li>
                  <li className="timeline-item">
                    ...
                    <div className="timeline-item-content flex-1 pl-4">
                      ...
                      <div className="mt-4 grid grid-cols-3 gap-3">
                        <img className="rounded-lg" src="images/object/object-1.jpg" alt="image" />
                        <img className="rounded-lg" src="images/object/object-2.jpg" alt="image" />
                        <img className="rounded-lg" src="images/object/object-3.jpg" alt="image" />
                        <img className="rounded-lg" src="images/object/object-4.jpg" alt="image" />
                        <img className="rounded-lg" src="images/object/object-5.jpg" alt="image" />
                        <img className="rounded-lg" src="images/object/object-6.jpg" alt="image" />
                      </div>
                      <div className="mt-4">
              ...
              <div className="pointer-events-none absolute bottom-4 flex w-full justify-center">
                <div className="pointer-events-auto mx-auto flex space-x-1 rounded-full border border-slate-150 bg-white px-4 py-0.5 shadow-lg dark:border-navy-700 dark:bg-navy-900">
                  <button className="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25 text-primary dark:text-accent">
                    ...
                    <svg x-show="activeTab !== 'tabHome'" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" style={{display: 'none'}}>
                  ...
                  <button  className="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
                    <svg x-show="activeTab === 'tabProjects'" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0" viewBox="0 0 20 20" fill="currentColor" style={{display: 'none'}}>
                  ...
                  <button className="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
                    <svg x-show="activeTab ===  'tabActivity'" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0" viewBox="0 0 20 20" fill="currentColor" style={{display: 'none'}}>
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                    </svg>
          ...
          <div className="flex items-center space-x-4 py-5 lg:py-6">
            ...
            <ul className="hidden flex-wrap items-center space-x-2 sm:flex">
              <li className="flex items-center space-x-2">
                <a className="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="#">Accounts</a>
            ...
            <div className="col-span-12 grid lg:col-span-4 lg:place-items-center">
              <div>
                <ol className="steps is-vertical line-space [--size:2.75rem] [--line:.5rem]">
                  <li className="step space-x-4 pb-12 before:bg-slate-200 dark:before:bg-navy-500 cursor-default">
                    <div className={`step-header mask is-hexagon dark:bg-accent ${currentStep == 1 ? "bg-primary text-white" : "bg-slate-200 text-slate-500 dark:bg-navy-500 dark:text-navy-100"}`}>
                    ...
                    <div className="text-left">
                      ...
                      <h3 className={`text-base font-medium dark:text-accent-light ${currentStep == 1 && ("text-primary")}`}>
                        Email
                      </h3>
                    </div>
                  </li>
                  <li className="step space-x-4 pb-12 before:bg-slate-200 dark:before:bg-navy-500 cursor-default">
                    <div className={`step-header mask is-hexagon dark:bg-accent ${currentStep == 2 ? "bg-primary text-white" : "bg-slate-200 text-slate-500 dark:bg-navy-500 dark:text-navy-100"}`}>
                      <i className="fa-solid fa-list text-base" />
                    </div>
                    <div className="text-left">
                      <p className="text-xs text-slate-400 dark:text-navy-300">
                        Step 2
                      </p>
                      <h3 className={`text-base font-medium dark:text-accent-light ${currentStep == 2 && ("text-primary")}`}>General</h3>
                    </div>
                  </li>
                  <li className="step space-x-4 pb-12 before:bg-slate-200 dark:before:bg-navy-500 cursor-default">
                    <div className={`step-header mask is-hexagon dark:bg-accent ${currentStep == 3 ? "bg-primary text-white" : "bg-slate-200 text-slate-500 dark:bg-navy-500 dark:text-navy-100"}`}>
                    ...
                    <div className="text-left">
                      ...
                      <h3 className={`text-base font-medium dark:text-accent-light ${currentStep == 3 && ("text-primary")}`}>Account Type</h3>
                    </div>
                  </li>
              ...
              <div className="card" style={{height : '250px'}}>
                <div className="border-b border-slate-200 p-4 dark:border-navy-500 sm:px-5">
                  <div className="flex items-center space-x-2">
                    ...
                    <h4 className="text-lg font-medium text-slate-700 dark:text-navy-100 cursor-default">
                      Email
                    </h4>
                  </div>
                </div>
 ...
 />
                ...
                <div className="flex justify-center space-x-2 pt-4">
                  <button className="btn space-x-2 bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" onClick={prevTab} disabled={currentStep == 1 ? true : false} style={{opacity : currentStep == 1 && '50%'}}>
...
>
                  ...
                  <button className="btn space-x-2 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" onClick={nextTab}>
                    <span>{currentStep == 3 ? 'Create' : 'Next'}</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
 ...
 />
              ...
              <label className="relative flex">
                <input x-init="$el._x_flatpickr = flatpickr($el,{altInput: true,altFormat: 'F j, Y',dateFormat: 'Y-m-d'})" className="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent cursor-pointer" placeholder="Choose date..." type="text" />
                <span className="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
...
>
            ...
            {currentStep == 3 && (<>
              ...
              <div className="card" style={{height : '250px'}}>
                ...
                <div className="space-y-4 p-4 sm:p-5">
                  {/* <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'> */}
 <label className="block" onClick={()=>setStep3DropdownOpen(!step3DropdownOpen)}>
  <span>Category</span>
  <select className="mt-1.5 w-full tomselected ts-hidden-accessible" x-init="$el._x_tom = new Tom($el,{create: true,sortField: {field: 'text',direction: 'asc'}})" id="tomselect-1" tabIndex={-1}>
    <option>Technology</option>
    <option>Home</option>
    <option>Other</option>
    <option>Digital</option>
    </select>
    <div className="ts-wrapper mt-1.5 w-full single full has-items focus input-active dropdown-active"><div className="ts-control"><div data-value="Digital" className="item" data-ts-item>{data.step3}</div><input type="select-one" autoComplete="off" size={1} tabIndex={0} role="combobox" aria-haspopup="listbox" aria-expanded="true" aria-controls="tomselect-1-ts-dropdown" id="tomselect-1-ts-control" placeholder aria-activedescendant="tomselect-1-opt-1" /></div><div className="ts-dropdown single" style={{display: step3DropdownOpen ? 'block' : 'none', visibility: step3DropdownOpen && 'visible'}}><div role="listbox" tabIndex={-1} className="ts-dropdown-content" id="tomselect-1-ts-dropdown">
      {accountType.map((type) => (
 <div
 data-selectable
 data-value={type.toLowerCase()}
 className={`option text-align-left ${data.step3 === type && ("selected active")}`} //select option based on the current type
 role="option"
 id={`tomselect-1-opt-${type.toLowerCase()}`}
 aria-selected={data.step3 === type} // set aria-selected based on the current type
