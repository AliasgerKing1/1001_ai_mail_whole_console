            ...
            <div className="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
              <div className="col-span-12 lg:col-span-8">
                <div className="flex items-center justify-between space-x-2">
                  ...
                  <div x-data="{activeTab:'tabRecent'}" className="is-scrollbar-hidden overflow-x-auto rounded-lg bg-slate-200 text-slate-600 dark:bg-navy-800 dark:text-navy-200">
                    <div className="tabs-list flex p-1">
                      <button className="btn shrink-0 px-3 py-1 text-xs+ font-medium">
                        Last month
                      </button>
                      <button className="btn shrink-0 px-3 py-1 text-xs+ font-medium">
                        Last year
                ...
                <div className="flex flex-col sm:flex-row sm:space-x-7">
                  <div className="mt-4 flex shrink-0 flex-col items-center sm:items-start">
                    ...
                    <div className="mt-3 flex items-center space-x-2">
                      <div className="ax-transparent-gridline w-28">
                        <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.analyticsSalesThisMonth); $el._x_chart.render() });" />
                      </div>
                  ...
                  <div className="ax-transparent-gridline grid w-full grid-cols-1">
                    <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.analyticsSalesOverview); $el._x_chart.render() });" />
                  </div>
                </div>
              </div>
                    ...
                    <div>
                      ...
                      <div className="mt-8 flex items-center justify-between space-x-2">
                        <div className="flex -space-x-3">
                          ...
                          <div className="avatar h-8 w-8 hover:z-10">
                            <img className="rounded-full ring ring-white dark:ring-navy-700" src="/assets/images/avatar/avatar-14.jpg" alt="avatar" />
                          </div>
                        </div>
                        <button className="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <div>
                      ...
                      <div className="mt-8 flex items-center justify-between space-x-2">
                        <div className="flex -space-x-3">
                          ...
                          <div className="avatar h-8 w-8 hover:z-10">
                            <img className="rounded-full ring ring-white dark:ring-navy-700" src="/assets/images/avatar/avatar-10.jpg" alt="avatar" />
                          </div>
                        </div>
                        <button className="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              ...
              <div className="is-scrollbar-hidden col-span-12 flex space-x-4 overflow-x-auto px-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-9 lg:pl-0">
                <div className="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                  <div className="flex items-center justify-between space-x-2">
                    <div className="flex items-center space-x-3">
                      <div className="avatar">
                        <img className="mask is-squircle" src="/assets/images/avatar/avatar-5.jpg" alt="image" />
                      </div>
                      <div>
                  ...
                  <div className="grow">
                    <div className="flex w-full space-x-1">
                      <div x-tooltip="'Phone Calls'" className="h-2 w-4/12 rounded-full bg-primary dark:bg-accent" />
                      <div x-tooltip="'Chats Messages'" className="h-2 w-3/12 rounded-full bg-success" />
                      <div x-tooltip="'Emails'" className="h-2 w-5/12 rounded-full bg-info" />
                    </div>
                    <div className="mt-2 flex flex-wrap">
                      <div className="mr-4 mb-1 inline-flex items-center space-x-2 font-inter">
                        <div className="h-2 w-2 rounded-full bg-primary dark:bg-accent" />
                ...
                <div className="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                  <div className="flex items-center justify-between space-x-2">
                    <div className="flex items-center space-x-3">
                      <div className="avatar">
                        <img className="mask is-squircle" src="/assets/images/avatar/avatar-18.jpg" alt="image" />
                      </div>
                      <div>
                        <p className="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                          Konnor Guzman
                  ...
                  <div className="grow">
                    <div className="flex w-full space-x-1">
                      <div x-tooltip="'Phone Calls'" className="h-2 w-3/12 rounded-full bg-primary dark:bg-accent" />
                      <div x-tooltip="'Chats Messages'" className="h-2 w-7/12 rounded-full bg-success" />
                      <div x-tooltip="'Emails'" className="h-2 w-2/12 rounded-full bg-info" />
                    </div>
                    <div className="mt-2 flex flex-wrap">
                      <div className="mr-4 mb-1 inline-flex items-center space-x-2 font-inter">
                        <div className="h-2 w-2 rounded-full bg-primary dark:bg-accent" />
                ...
                <div className="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                  <div className="flex items-center justify-between space-x-2">
                    <div className="flex items-center space-x-3">
                      <div className="avatar">
                        <img className="mask is-squircle" src="/assets/images/avatar/avatar-6.jpg" alt="image" />
                      </div>
                      <div>
                        <p className="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                          Alfredo Elliott
                  ...
                  <div className="grow">
                    <div className="flex w-full space-x-1">
                      <div x-tooltip="'Phone Calls'" className="h-2 w-8/12 rounded-full bg-primary dark:bg-accent" />
                      <div x-tooltip="'Chats Messages'" className="h-2 w-2/12 rounded-full bg-success" />
                      <div x-tooltip="'Emails'" className="h-2 w-2/12 rounded-full bg-info" />
                    </div>
                    <div className="mt-2 flex flex-wrap">
                      <div className="mr-4 mb-1 inline-flex items-center space-x-2 font-inter">
                ...
                <div className="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                  <div className="flex items-center justify-between space-x-2">
                    <div className="flex items-center space-x-3">
                      <div className="avatar">
                        <img className="mask is-squircle" src="/assets/images/avatar/avatar-11.jpg" alt="image" />
                      </div>
                      <div>
                        <p className="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                          Samantha Shelton
                  ...
                  <div className="grow">
                    <div className="flex w-full space-x-1">
                      <div x-tooltip="'Phone Calls'" className="h-2 w-4/12 rounded-full bg-primary dark:bg-accent" />
                      <div x-tooltip="'Chats Messages'" className="h-2 w-4/12 rounded-full bg-success" />
                      <div x-tooltip="'Emails'" className="h-2 w-4/12 rounded-full bg-info" />
                    </div>
                    <div className="mt-2 flex flex-wrap">
                      <div className="mr-4 mb-1 inline-flex items-center space-x-2 font-inter">
                        <div className="h-2 w-2 rounded-full bg-primary dark:bg-accent" />
                ...
                <div className="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                  <div className="flex items-center justify-between space-x-2">
                    <div className="flex items-center space-x-3">
                      <div className="avatar">
                        <img className="mask is-squircle" src="/assets/images/avatar/avatar-19.jpg" alt="image" />
                      </div>
                      <div>
                        <p className="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                          Derrick Simmons
                  ...
                  <div className="grow">
                    <div className="flex w-full space-x-1">
                      <div x-tooltip="'Phone Calls'" className="h-2 w-6/12 rounded-full bg-primary dark:bg-accent" />
                      <div x-tooltip="'Chats Messages'" className="h-2 w-4/12 rounded-full bg-success" />
                      <div x-tooltip="'Emails'" className="h-2 w-2/12 rounded-full bg-info" />
                    </div>
                    <div className="mt-2 flex flex-wrap">
                ...
                <div className="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                  <div className="flex items-center justify-between space-x-2">
                    <div className="flex items-center space-x-3">
                      <div className="avatar">
                        <img className="mask is-squircle" src="/assets/images/avatar/avatar-7.jpg" alt="image" />
                      </div>
                      <div>
                        <p className="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                          Katrina West
                  ...
                  <div className="grow">
                    <div className="flex w-full space-x-1">
                      <div x-tooltip="'Phone Calls'" className="h-2 w-1/12 rounded-full bg-primary dark:bg-accent" />
                      <div x-tooltip="'Chats Messages'" className="h-2 w-5/12 rounded-full bg-success" />
                      <div x-tooltip="'Emails'" className="h-2 w-6/12 rounded-full bg-info" />
                    </div>
                    <div className="mt-2 flex flex-wrap">
                      <div className="mr-4 mb-1 inline-flex items-center space-x-2 font-inter">
                        <div className="h-2 w-2 rounded-full bg-primary dark:bg-accent" />
            ...
            <div className="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
              <div className="card col-span-12 sm:col-span-6">
                ...
                <div className="ax-transparent-gridline ax-rounded-b-lg">
                  <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.analyticsBandwidth); $el._x_chart.render() });" />
                </div>
              </div>
