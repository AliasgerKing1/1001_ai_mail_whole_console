          ...
          <div className="card">
            <div className="p-2 text-right">
              <div x-data="usePopper({placement:'bottom-end',offset:4})" className="inline-flex">
                ...
                <div x-ref="popperRoot" className="popper-root" style={{position: 'fixed', inset: '0px 0px auto auto', margin: '0px', transform: 'translate(-750px, 188px)'}} data-popper-placement="bottom-end">
